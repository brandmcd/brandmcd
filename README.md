...
🔬 Undergraduate researcher on **iGym (AR/XR systems for inclusive play)**  
...
### 🔬 Selected Experience
- Refactored and multithreaded **ROS 2 + OpenCV** perception pipelines, reducing latency **12 ms → 5 ms**  
